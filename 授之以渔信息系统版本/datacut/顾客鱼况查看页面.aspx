<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="顾客鱼况查看页面.aspx.cs" Inherits="datacut.顾客鱼况查看页面" %>
									...
									<table id="Table2" cellspacing="0" cellpadding="0" width="700" border="0">
										...
										<tr>
											...
											<td vAlign="top" bgColor="white" width="700" height="500" 
                                                style="text-align: left; font-family: 宋体, Arial, Helvetica, sans-serif;">
												 &nbsp;<br />
                                                 &nbsp;Fishery: 
                                                 <asp:DropDownList ID="DropDownList2" runat="server">
                                                 </asp:DropDownList>
&nbsp; 月份：<asp:DropDownList ID="DropDownList4" runat="server">
...
&nbsp;&nbsp;
                                                ...
                                                <br />
                                                <br />
					                             <asp:Chart ID="Chart1" runat="server" Height="218px" Width="303px">
                                                     <series>
                                                 ...
                                                 <br />
                                                 <br />
                                                 <asp:Button ID="Button2" runat="server" Text="查看相关评论" />
                                                 <br />
                                                 <br />
												<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                                 ...
                                                 BackColor="White" BorderWidth="1px" PageSize="8" 
                                                     Width="510px" HorizontalAlign="Left" 
                                                    >
                    ...
                    BorderWidth="1px" />
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="grade" HeaderText="危险等级" SortExpression="grade" />
                                                        <asp:BoundField DataField="advice" HeaderText="评论内容" SortExpression="advice" />
                                                    </Columns>
