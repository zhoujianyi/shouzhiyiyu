<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="顾客信息查询页面.aspx.cs" Inherits="datacut.顾客信息查询页面" %>
				...
				<table cellspacing="0" cellpadding="0" width="750" align="center" border="0">
                    ...
                    BorderWidth="1px" />
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="name" HeaderText="顾客" SortExpression="name" />
                                                        <asp:BoundField DataField="mount" HeaderText="销量" SortExpression="mount" />
                                                        <asp:BoundField DataField="date" HeaderText="时间" SortExpression="date" />
                                                        <asp:BoundField DataField="period" HeaderText="季度" SortExpression="period" />
                                                    </Columns>
                                                ...
                                                <br />
                                                种类：<asp:DropDownList ID="DropDownList1" runat="server">
                                                </asp:DropDownList>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 季度：<asp:DropDownList ID="DropDownList2" runat="server">
                                                </asp:DropDownList>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <asp:Button ID="Button1" runat="server" Text="分析" onclick="Button1_Click" />

                                                <asp:Panel ID="panel1" runat="server" GroupingText="分析结果" Visible="False">
                                                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Larger" 
                                                        ForeColor="Red" Text="没有匹配的结果，请重新选择" Visible="False"></asp:Label>
                                                    <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                                                        AutoGenerateColumns="False" CellPadding="4" 
                                                        EnableTheming="True" OnPageIndexChanging="GridView2_PageIndexChanging" 
                                                        PageSize="4" ForeColor="#333333" GridLines="None">
                                                        <AlternatingRowStyle BorderColor="#000099" BorderStyle="Solid" 
